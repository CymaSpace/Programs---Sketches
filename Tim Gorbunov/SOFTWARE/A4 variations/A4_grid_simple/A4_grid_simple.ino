...
#define NUM_LEDS 26 // Number of LED's in the strip
...
CRGB leds[251]; // Represents LED strip
...
void loop() {
  ...
  if(refresh_counter >= refresh_rate) {
    ...
    for(i = LEFT_START_POINT; i >= LEFT_END_POINT; --i) {
      ...
      set_LED_color(51-i, left_LED_stack[stack_loop]);
      set_LED_color(76-i, left_LED_stack[stack_loop]);
      set_LED_color(101-i, left_LED_stack[stack_loop]);
      set_LED_color(126-i, left_LED_stack[stack_loop]);
      set_LED_color(151-i, left_LED_stack[stack_loop]);
      set_LED_color(176-i, left_LED_stack[stack_loop]);
      set_LED_color(201-i, left_LED_stack[stack_loop]);
      set_LED_color(226-i, left_LED_stack[stack_loop]);
      set_LED_color(251-i, left_LED_stack[stack_loop]);
      ++stack_loop;
    }
    ...
    for(i = RIGHT_START_POINT; i <= RIGHT_END_POINT; ++i) {
      ...
      set_LED_color(51-i, right_LED_stack[stack_loop]);
      set_LED_color(76-i, right_LED_stack[stack_loop]);
      set_LED_color(101-i, right_LED_stack[stack_loop]);
      set_LED_color(126-i, right_LED_stack[stack_loop]);
      set_LED_color(151-i, right_LED_stack[stack_loop]);
      set_LED_color(176-i, right_LED_stack[stack_loop]);
      set_LED_color(201-i, right_LED_stack[stack_loop]);
      set_LED_color(226-i, right_LED_stack[stack_loop]);
      set_LED_color(251-i, right_LED_stack[stack_loop]);
      ++stack_loop;
    }
