...
#define REFRESH_DIVISOR 20. // Higher = range of refresh values is lower
...
#define LEFT_END_POINT (NUM_LEDS - 1) // Generally the end of the left side is the first LED
...
#define MIN_AMPLITUDE 450 // Lowest possible amplitude value (Higher number causes there to be more blank LED's)
